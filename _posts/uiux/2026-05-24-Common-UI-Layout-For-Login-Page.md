...
categories: ui-ux
series-code: n/a
excerpt: There are at least three archetypes of login page layout. Each layout has its own advantages and disadvantages over the other layout. Formal digital product tend to use two column style login page while non formal digital product opted to only use only single column login form.
tags: mockup login-page
background: Login page is second most important page after landing page in the context of sales conversion as it act as a bridge between landing page with the actual working product. Login page must give correct product impressions to the target user. Giving higher chance of conversion.
objective: To list down common login layout that used on digital products
deliverables: Article & Illustration
typora-root-url: ./../../../../
title: Common User Interface Layout for Login Page
---
...
1. login form using username and password
2. SSO (single sign on) login (gmail, apple, facebook or github)
3. registration links (if the user prefer to not use the SSO
...
&mdash; which position is the best for login form?
...
Generally its not recommended to use this style/layout as it make the header to be complex and h**uman can only focus one one thing/objectives at once**.
